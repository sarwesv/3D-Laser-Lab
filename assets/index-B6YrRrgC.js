	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};tl.BlurDirectionX=new G(1,0),tl.BlurDirectionY=new G(0,1);var nl,rl,il,al,ol,sl,cl=null,ll=!1,ul=!1,$=null,dl=[],fl,pl,ml=!1,hl=!1,gl=!1,_l={},vl={theta:Math.PI/4,phi:Math.PI/4,radius:3},yl=new K(0,0,0),bl=!1,xl=null,Sl=[],Cl=[],wl={x:0,y:0},Tl=0,El=0,Dl=[],Ol=`sandbox`,kl=0;parseInt(localStorage.getItem(`unlockedLevelIndex`)||`0`);var Al={laser:1/0,mirror:1/0,prism:1/0,absorber:1/0},jl=[{title:`Level 1: The Basics`,instructions:`Place a laser emitter to hit the target directly.`,inventory:{laser:1,mirror:0,prism:0,absorber:0},targets:[{pos:[0,.5,-2]}],fixedObjects:[]},{title:`Level 2: Reflection`,instructions:`A laser is blocked! Use a mirror to redirect it to the target.`,inventory:{laser:0,mirror:1,prism:0,absorber:0},targets:[{pos:[2,.5,0]}],fixedObjects:[{type:`laser`,pos:[-2,.02,0],rotH:-Math.PI/2,rotV:0,fixed:!0},{type:`absorber`,pos:[0,.075,0],fixed:!0}]},{title:`Level 3: Splitting`,instructions:`Use a prism to hit both targets simultaneously.`,inventory:{laser:0,mirror:0,prism:1,absorber:0},targets:[{pos:[1.5,.5,-1.5]},{pos:[1.5,.5,1.5]}],fixedObjects:[{type:`laser`,pos:[-2,.02,0],rotH:-Math.PI/2,rotV:0,fixed:!0}]}];Ml(),Vl();function Ml(){nl=document.getElementById(`container`),il=new fn,il.background=new Y(16119802),rl=new Qi(70,window.innerWidth/window.innerHeight,.01,20);let e=new Bi(16777215,12303359,1);e.position.set(.5,1,.25),il.add(e);let t=new ta(16777215,.5);t.position.set(5,10,5),il.add(t),al=new Uc({antialias:!0,alpha:!0}),al.setPixelRatio(window.devicePixelRatio),al.setSize(window.innerWidth,window.innerHeight),nl.appendChild(al.domElement),ol=new Qc(al);let n=new $c(il,rl);ol.addPass(n);let r=new tl(new G(window.innerWidth,window.innerHeight),0,.3,.9);ol.addPass(r),sl=new Or(new si(.15,.2,32).rotateX(-Math.PI/2),new gr({color:16777215,transparent:!0,opacity:.5})),sl.visible=!1,il.add(sl),document.querySelectorAll(`.inventory-item`).forEach(e=>{e.addEventListener(`click`,()=>{if(e.id===`btn-delete`){ll=!ll,e.classList.toggle(`active`,ll),ll&&(cl=null,document.querySelectorAll(`.inventory-item`).forEach(e=>{e.id!==`btn-delete`&&(e.style.background=``)}),Pl());return}cl=cl===e.dataset.type?null:e.dataset.type,cl&&(ll=!1,xl=null,document.getElementById(`btn-delete`).classList.remove(`active`),document.getElementById(`rotation-container`).style.display=`none`),document.querySelectorAll(`.inventory-item`).forEach(e=>{e.id!==`btn-delete`&&(e.style.background=``)}),cl?(e.style.background=`rgba(255, 255, 255, 0.2)`,Nl()):Pl()})}),document.getElementById(`btn-start`).addEventListener(`click`,()=>{let e=Sl.some(e=>e.userData.type===`laser`);if(!ul&&!e){alert(`Please place at least one Laser Emitter first!`);return}ul=!ul;let t=document.getElementById(`btn-start`);t.textContent=ul?`Stop Laser`:`Start Laser`,t.classList.toggle(`active`,ul),Il()}),document.getElementById(`btn-grid-toggle`).addEventListener(`click`,()=>{bl=!bl;let e=document.getElementById(`btn-grid-toggle`);e.textContent=bl?`🌐 Grid: Infinite`:`🌐 Grid: Fixed`,e.classList.toggle(`active`,bl),!bl&&pl&&fl?(pl.position.set(0,0,0),fl.position.set(0,0,0)):zl()}),document.getElementById(`btn-toggle-menu`).addEventListener(`click`,()=>{let e=document.getElementById(`action-menu`).classList.toggle(`collapsed`);document.getElementById(`btn-toggle-menu`).innerText=e?`⚙️`:`❌`}),document.getElementById(`btn-clear`).addEventListener(`click`,()=>{window.confirm(`Are you sure you want to clear all objects? This cannot be undone.`)&&(Ul(),Ol===`challenges`&&loadLevel(kl))});let i=document.getElementById(`btn-mode-sandbox`),a=document.getElementById(`btn-mode-challenges`),o=document.getElementById(`level-overlay`);window.updateInventoryUI=()=>{Object.keys(Al).forEach(e=>{let t=document.getElementById(`item-${e}`);if(!t)return;let n=t.querySelector(`.item-count`);n||(n=document.createElement(`div`),n.className=`item-count`,t.appendChild(n)),Ol===`challenges`?(n.style.display=`block`,n.innerText=Al[e],Al[e]<=0?(t.style.opacity=`0.4`,t.style.pointerEvents=`none`):(t.style.opacity=`1`,t.style.pointerEvents=`auto`)):(n.style.display=`none`,t.style.opacity=`1`,t.style.pointerEvents=`auto`)})},window.loadLevel=e=>{Ul(),kl=e;let t=jl[e];document.getElementById(`level-title`).innerText=t.title,document.getElementById(`level-instructions`).innerText=t.instructions,o.style.display=`block`,Al={...t.inventory},window.updateInventoryUI(),t.targets.forEach(e=>{let t=new Or(new ci(.15,16,16),new bi({color:4473924,emissive:0,roughness:.5}));t.position.set(e.pos[0],e.pos[1],e.pos[2]),t.userData.isTarget=!0,t.userData.active=!1,il.add(t),Cl.push(t)}),t.fixedObjects.forEach(e=>{Tl=e.rotH||0,El=e.rotV||0,Fl(e.type,null,e.pos,null,e.fixed)}),Tl=0,El=0},i.addEventListener(`click`,()=>{Ol=`sandbox`,i.classList.add(`active`),a.classList.remove(`active`),o.style.display=`none`,Al={laser:1/0,mirror:1/0,prism:1/0,absorber:1/0},window.updateInventoryUI(),Ul()}),a.addEventListener(`click`,()=>{Ol=`challenges`,a.classList.add(`active`),i.classList.remove(`active`),window.loadLevel(kl)});let s=document.getElementById(`rotation-slider-h`),c=document.getElementById(`rotation-slider-v`),l=()=>{let e=parseFloat(s.value)*(Math.PI/180),t=parseFloat(c.value)*(Math.PI/180);Tl=e,El=t,xl?(xl.userData.rotationH=e,xl.userData.rotationV=t,xl.rotation.set(0,0,0),xl.rotation.order=`YXZ`,xl.userData.type===`laser`?(xl.rotation.y=e,xl.rotation.x=Math.PI/2-t):xl.userData.type===`mirror`&&(xl.rotation.y=e,xl.rotation.x=t),ul&&Il()):$&&($.rotation.set(0,0,0),$.rotation.order=`YXZ`,cl===`laser`?($.rotation.y=e,$.rotation.x=Math.PI/2-t):cl===`mirror`&&($.rotation.y=e,$.rotation.x=t),Il())};s.addEventListener(`input`,l),c.addEventListener(`input`,l),window.addEventListener(`resize`,Bl),Ll()}function Nl(){Pl();let e,t;cl===`laser`?(e=new ii(.02,.02,.1,16),t=new bi({color:2236962,transparent:!0,opacity:.5}),$=new Or(e,t),$.rotation.x=Math.PI/2,document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-label-h`).innerText=`Horizontal Angle`,document.getElementById(`rotation-label-v`).style.display=`block`,document.getElementById(`rotation-slider-v`).style.display=`block`):cl===`mirror`?(e=new ri(.2,.2,.02),t=new bi({color:8965375,transparent:!0,opacity:.5}),$=new Or(e,t),document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-label-h`).innerText=`Horizontal Angle`,document.getElementById(`rotation-label-v`).style.display=`block`,document.getElementById(`rotation-slider-v`).style.display=`block`):(cl===`prism`||cl===`absorber`)&&(cl===`prism`?(e=new li(.12),t=new bi({color:13434879,transparent:!0,opacity:.5})):(e=new ri(.15,.15,.15),t=new bi({color:2236962,transparent:!0,opacity:.5})),$=new Or(e,t),document.getElementById(`rotation-container`).style.display=`none`),$&&($.visible=!1,il.add($))}function Pl(){$&&(il.remove($),$=null,document.getElementById(`rotation-container`).style.display=`none`,ul||(dl.forEach(e=>il.remove(e)),dl=[]))}function Fl(e,t,n=null,r=null,i=!1){if(Ol===`challenges`&&!i){if(Al[e]<=0)return;Al[e]--,window.updateInventoryUI()}let a,o,s;e===`laser`?(a=new ii(.02,.02,.1,16),o=new bi({color:2236962}),s=new Or(a,o),s.userData.rotationH=Tl,s.userData.rotationV=El,n?s.position.fromArray(n):t&&s.position.setFromMatrixPosition(t),s.position.y=.02,s.rotation.order=`YXZ`,s.rotation.y=Tl,s.rotation.x=Math.PI/2-El):e===`mirror`?(a=new ri(.2,.2,.02),o=new bi({color:8965375,metalness:1,roughness:0}),s=new Or(a,o),s.userData.rotationH=Tl,s.userData.rotationV=El,n?s.position.fromArray(n):t&&s.position.setFromMatrixPosition(t),s.position.y=.1,s.rotation.order=`YXZ`,s.rotation.y=Tl,s.rotation.x=El):(e===`prism`||e===`absorber`)&&(e===`prism`?(a=new li(.12),o=new bi({color:13434879,transparent:!0,opacity:.7,metalness:.2,roughness:.1})):(a=new ri(.15,.15,.15),o=new bi({color:2236962})),s=new Or(a,o),n?s.position.fromArray(n):t&&s.position.setFromMatrixPosition(t),s.position.y=e===`prism`?.08:.075),r&&s.quaternion.fromArray(r),s.userData.type=e,s.userData.isFixed=i,i&&(s.material.emissive=new Y(2236962)),il.add(s),Sl.push(s),ul&&Il()}function Il(){if(!ul&&cl!==`laser`){dl.forEach(e=>il.remove(e)),dl=[];return}let e=Sl.filter(e=>e.userData.type===`laser`).map(e=>({pos:e.position.clone(),quat:e.quaternion.clone()}));if(cl===`laser`&&$&&$.visible&&e.push({pos:$.position.clone(),quat:$.quaternion.clone()}),e.length===0){dl.forEach(e=>e.visible=!1);return}Dl=[];let t=[];e.forEach(e=>{let n=new K(0,0,-1).applyQuaternion(e.quat).normalize(),r=e.pos.clone().add(n.clone().multiplyScalar(.05));t.push({pos:r,dir:n,depth:0,color:16777215})});let n=new xa;for(;t.length>0&&Dl.length<128;){let{pos:e,dir:r,depth:i,color:a}=t.shift();if(i>24)continue;let o=[e.clone()],s=[0],c=e.clone(),l=r.clone(),u=0,d=!1;for(;!d;){n.set(c,l);let e=[...Sl.filter(e=>e.userData.type!==`laser`)];fl&&e.push(fl);let r=n.intersectObjects(e);if(r.length>0){let e=r[0];if(u+=e.distance,o.push(e.point.clone()),s.push(u),e.object.userData&&e.object.userData.type===`mirror`){let n=e.face.normal.clone().applyMatrix4(new kt().extractRotation(e.object.matrixWorld));l.reflect(n).normalize(),t.push({pos:e.point.clone().add(l.clone().multiplyScalar(.001)),dir:l.clone(),depth:i+1,color:a}),d=!0}else e.object.userData&&e.object.userData.type===`prism`&&[{angle:-.15,color:a===16777215?16711680:a},{angle:0,color:a===16777215?65280:a},{angle:.15,color:a===16777215?255:a}].forEach(n=>{let r=l.clone(),a=new K(0,1,0).cross(r).normalize();a.length()<.1&&a.set(1,0,0),r.applyAxisAngle(a,n.angle),t.push({pos:e.point.clone().add(r.clone().multiplyScalar(.01)),dir:r,depth:i+1,color:n.color})}),d=!0}else{let e=1e3;u+=e,o.push(c.clone().add(l.clone().multiplyScalar(e))),s.push(u),d=!0}o.length>20&&(d=!0)}Dl.push({points:o,distances:s,color:a})}for(;dl.length<Dl.length;){let e=new ii(.01,.01,1,8);e.rotateX(Math.PI/2);let t=new Or(e,new gr({color:16777215}));il.add(t),dl.push(t)}for(;dl.length>Dl.length;){let e=dl.pop();il.remove(e)}}function Ll(){ml||(ml=!0,fl=new Or(new oi(100,100),new bi({color:15658734,roughness:.8})),fl.rotation.x=-Math.PI/2,fl.receiveShadow=!0,il.add(fl),pl=new wa(100,100,4473924,8947848),pl.position.y=.01,il.add(pl),Rl())}function Rl(){if(hl)return;hl=!0;let e={x:0,y:0},t=new xa,n=new G;window.addEventListener(`keydown`,e=>{_l[e.code]=!0}),window.addEventListener(`keyup`,e=>{_l[e.code]=!1}),window.addEventListener(`wheel`,e=>{ml&&(vl.radius+=e.deltaY*.005,vl.radius=Math.max(.5,Math.min(20,vl.radius)),r())});function r(){rl.position.x=yl.x+vl.radius*Math.sin(vl.phi)*Math.cos(vl.theta),rl.position.y=yl.y+vl.radius*Math.cos(vl.phi),rl.position.z=yl.z+vl.radius*Math.sin(vl.phi)*Math.sin(vl.theta),rl.lookAt(yl)}r();let i=e=>{n.x=e.clientX/window.innerWidth*2-1,n.y=-(e.clientY/window.innerHeight)*2+1};window.addEventListener(`pointerdown`,t=>{t.target.tagName===`CANVAS`&&(gl=!0,wl={x:t.clientX,y:t.clientY},e={x:t.clientX,y:t.clientY})}),window.addEventListener(`pointermove`,e=>{(!ml||e.target.tagName!==`CANVAS`)&&(gl||(sl.visible=!1)),i(e),t.setFromCamera(n,rl);let a=t.intersectObject(fl);if(a.length>0?(sl.visible=!0,sl.position.copy(a[0].point)):sl.visible=!1,!gl)return;let o=e.clientX-wl.x,s=e.clientY-wl.y;vl.theta-=o*.01,vl.phi-=s*.01,vl.phi=Math.max(.1,Math.min(Math.PI/2-.1,vl.phi)),wl={x:e.clientX,y:e.clientY},r()}),window.addEventListener(`pointerup`,r=>{if(gl&&(gl=!1,Math.sqrt((r.clientX-e.x)**2+(r.clientY-e.y)**2)<10&&ml&&r.target.tagName===`CANVAS`)){i(r),t.setFromCamera(n,rl);let e=t.intersectObjects(Sl);if(e.length>0){let t=e[0].object;if(ll){if(t.userData.isFixed){alert(`This object is fixed and cannot be removed!`);return}il.remove(t),Sl=Sl.filter(e=>e!==t),Ol===`challenges`&&(Al[t.userData.type]++,window.updateInventoryUI()),xl===t&&(xl=null,document.getElementById(`rotation-container`).style.display=`none`),ul&&Il();return}if(t.userData.isFixed&&(t.userData.type===`laser`||t.userData.type),t.userData.type===`laser`||t.userData.type===`mirror`){xl=t,cl=null,document.querySelectorAll(`.inventory-item`).forEach(e=>e.style.background=``),Pl(),document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-slider-h`).value=(t.userData.rotationH||0)*(180/Math.PI),document.getElementById(`rotation-slider-v`).value=(t.userData.rotationV||0)*(180/Math.PI);return}}let a=t.intersectObject(fl);cl&&a.length>0&&Fl(cl,null,a[0].point.toArray())}}),window.update3DMovement=()=>{if(!ml)return;let e=!1,t=.05,n=new K;rl.getWorldDirection(n),n.y=0,n.normalize();let i=new K().crossVectors(n,new K(0,1,0)).normalize();_l.KeyW&&(yl.add(n.clone().multiplyScalar(t)),e=!0),_l.KeyS&&(yl.sub(n.clone().multiplyScalar(t)),e=!0),_l.KeyA&&(yl.add(i.clone().multiplyScalar(t)),e=!0),_l.KeyD&&(yl.sub(i.clone().multiplyScalar(t)),e=!0),_l.ArrowUp&&(vl.radius-=.1,e=!0),_l.ArrowDown&&(vl.radius+=.1,e=!0),e&&(vl.radius=Math.max(.5,Math.min(20,vl.radius)),r(),bl&&zl())}}function zl(){!bl||!pl||!fl||(pl.position.x=Math.floor(yl.x/1)*1,pl.position.z=Math.floor(yl.z/1)*1,fl.position.x=pl.position.x,fl.position.z=pl.position.z)}function Bl(){rl.aspect=window.innerWidth/window.innerHeight,rl.updateProjectionMatrix(),al.setSize(window.innerWidth,window.innerHeight),ol&&ol.setSize(window.innerWidth,window.innerHeight)}function Vl(){al.setAnimationLoop(Hl)}function Hl(){window.update3DMovement&&window.update3DMovement(),ul&&Il(),$&&(sl.visible?($.visible=!0,$.position.copy(sl.position),cl===`laser`?$.position.y=.02:cl===`mirror`?$.position.y=.1:cl===`prism`?$.position.y=.08:cl===`absorber`&&($.position.y=.075),$.updateMatrixWorld(),Il()):($.visible=!1,ul||(dl.forEach(e=>il.remove(e)),dl=[]))),(ul||cl===`laser`)&&dl.length>0&&Dl.length>0?Dl.forEach((e,t)=>{let n=dl[t];if(!n||e.points.length<2){n&&(n.visible=!1);return}n.material.color.setHex(e.color||16777215);let r=e.points[0],i=e.points[e.points.length-1],a=new K().subVectors(i,r),o=a.length();n.scale.set(1,1,o),n.position.copy(r).add(a.clone().multiplyScalar(.5)),n.lookAt(i),n.visible=!0}):ul||dl.forEach(e=>e.visible=!1),ol?ol.render():al.render(il,rl)}function Ul(){Sl.forEach(e=>il.remove(e)),Sl=[],dl.forEach(e=>il.remove(e)),dl=[],xl=null;let e=document.getElementById(`rotation-container`);e&&(e.style.display=`none`)}