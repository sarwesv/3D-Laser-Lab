...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(e,t,n){let r=new Float32Array(Ba),i=new K(0,1,0);return new vi({name:`SphericalGaussianBlur`,defines:{n:Ba,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ro(),fragmentShader:`
	...
	`}var io=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $r(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};tl.BlurDirectionX=new G(1,0),tl.BlurDirectionY=new G(0,1);var nl,rl,il,al,ol,sl,cl=null,ll=!1,ul=!1,$=null,dl=[],fl,pl,ml=!1,hl=!1,gl=!1,_l={},vl={theta:Math.PI/4,phi:Math.PI/4,radius:3},yl=new K(0,0,0),bl=!1,xl=null,Sl=[],Cl=[],wl={x:0,y:0},Tl=0,El=0,Dl=[],Ol=`sandbox`,kl=0,Al=parseInt(localStorage.getItem(`unlockedLevelIndex`)||`0`),jl=!1,Ml={laser:1/0,mirror:1/0,prism:1/0,absorber:1/0},Nl=[{title:`Level 1: The Basics`,instructions:`Place a laser emitter to hit the target directly.`,inventory:{laser:1,mirror:0,prism:0,absorber:0},targets:[{pos:[0,.1,-2]}],fixedObjects:[]},{title:`Level 2: Reflection`,instructions:`A laser is blocked! Use a mirror to redirect it to the target.`,inventory:{laser:0,mirror:1,prism:0,absorber:0},targets:[{pos:[2,.1,0]}],fixedObjects:[{type:`laser`,pos:[-2,.05,0],rotH:-Math.PI/2,rotV:0,fixed:!0},{type:`absorber`,pos:[0,.075,0],fixed:!0}]},{title:`Level 3: Splitting`,instructions:`Use a prism to hit both targets simultaneously.`,inventory:{laser:0,mirror:0,prism:1,absorber:0},targets:[{pos:[1.5,.1,-1.5]},{pos:[1.5,.1,1.5]}],fixedObjects:[{type:`laser`,pos:[-2,.05,0],rotH:-Math.PI/2,rotV:0,fixed:!0}]},{title:`Level 4: Zig-Zag`,instructions:`Use two mirrors to navigate around the barriers to the target.`,inventory:{laser:0,mirror:2,prism:0,absorber:0},targets:[{pos:[-2,.1,-2]}],fixedObjects:[{type:`laser`,pos:[-2,.05,2],rotH:0,rotV:0,fixed:!0},{type:`absorber`,pos:[-2,.075,.5],fixed:!0},{type:`absorber`,pos:[0,.075,-1],fixed:!0}]},{title:`Level 5: The Perimeter`,instructions:`The target is far away. Use mirrors to bounce light along the edges.`,inventory:{laser:0,mirror:3,prism:0,absorber:0},targets:[{pos:[4,.1,4]}],fixedObjects:[{type:`laser`,pos:[-4,.05,-4],rotH:0,rotV:0,fixed:!0}]},{title:`Level 6: Web of Light`,instructions:`Split the beam and then reflect both rays into the targets.`,inventory:{laser:0,mirror:2,prism:1,absorber:0},targets:[{pos:[-3,.1,-3]},{pos:[3,.1,-3]}],fixedObjects:[{type:`laser`,pos:[0,.05,3],rotH:Math.PI,rotV:0,fixed:!0}]}];Fl(),Wl();function Pl(e){let t=document.getElementById(`notification-container`);if(!t)return;let n=document.createElement(`div`);n.className=`notification`,n.innerText=e,t.appendChild(n),setTimeout(()=>{n.parentElement&&t.removeChild(n)},3e3)}function Fl(){nl=document.getElementById(`container`),il=new fn,il.background=new Y(16119802),rl=new Qi(70,window.innerWidth/window.innerHeight,.01,20);let e=new Bi(16777215,12303359,1);e.position.set(.5,1,.25),il.add(e);let t=new ta(16777215,.5);t.position.set(5,10,5),il.add(t),al=new Uc({antialias:!0,alpha:!0}),al.setPixelRatio(window.devicePixelRatio),al.setSize(window.innerWidth,window.innerHeight),nl.appendChild(al.domElement),ol=new Qc(al);let n=new $c(il,rl);ol.addPass(n);let r=new tl(new G(window.innerWidth,window.innerHeight),0,.3,.9);ol.addPass(r),sl=new Or(new si(.15,.2,32).rotateX(-Math.PI/2),new gr({color:16777215,transparent:!0,opacity:.5})),sl.visible=!1,il.add(sl),document.querySelectorAll(`.inventory-item`).forEach(e=>{e.addEventListener(`click`,()=>{if(e.id===`btn-delete`){ll=!ll,e.classList.toggle(`active`,ll),ll&&(cl=null,document.querySelectorAll(`.inventory-item`).forEach(e=>{e.id!==`btn-delete`&&(e.style.background=``)}),Ll());return}cl=cl===e.dataset.type?null:e.dataset.type,cl&&(ll=!1,xl=null,document.getElementById(`btn-delete`).classList.remove(`active`),document.getElementById(`rotation-container`).style.display=`none`),document.querySelectorAll(`.inventory-item`).forEach(e=>{e.id!==`btn-delete`&&(e.style.background=``)}),cl?(e.style.background=`rgba(255, 255, 255, 0.2)`,Il()):Ll()})}),document.getElementById(`btn-start`).addEventListener(`click`,()=>{let e=Sl.some(e=>e.userData.type===`laser`);if(!ul&&!e){Pl(`Please place at least one Laser Emitter first!`);return}ul=!ul;let t=document.getElementById(`btn-start`);t.textContent=ul?`Stop Laser`:`Start Laser`,t.classList.toggle(`active`,ul),zl()}),document.getElementById(`btn-grid-toggle`).addEventListener(`click`,()=>{bl=!bl;let e=document.getElementById(`btn-grid-toggle`);e.textContent=bl?`🌐 Grid: Infinite`:`🌐 Grid: Fixed`,e.classList.toggle(`active`,bl),!bl&&pl&&fl?(pl.position.set(0,0,0),fl.position.set(0,0,0)):Hl()}),document.getElementById(`btn-toggle-menu`).addEventListener(`click`,()=>{let e=document.getElementById(`action-menu`).classList.toggle(`collapsed`);document.getElementById(`btn-toggle-menu`).innerText=e?`⚙️`:`❌`}),document.getElementById(`btn-clear`).addEventListener(`click`,()=>{window.confirm(`Are you sure you want to clear all objects? This cannot be undone.`)&&(Kl(),Ol===`challenges`&&window.loadLevel(kl))});let i=document.getElementById(`btn-mode-sandbox`),a=document.getElementById(`btn-mode-challenges`),o=document.getElementById(`level-overlay`);window.updateInventoryUI=()=>{Object.keys(Ml).forEach(e=>{let t=document.getElementById(`item-${e}`);if(!t)return;let n=t.querySelector(`.item-count`);n||(n=document.createElement(`div`),n.className=`item-count`,t.appendChild(n)),Ol===`challenges`?(n.style.display=`block`,n.innerText=Ml[e],Ml[e]<=0?(t.style.opacity=`0.4`,t.style.pointerEvents=`none`):(t.style.opacity=`1`,t.style.pointerEvents=`auto`)):(n.style.display=`none`,t.style.opacity=`1`,t.style.pointerEvents=`auto`)})},window.loadLevel=e=>{jl=!1,Kl(),kl=e;let t=Nl[e];if(document.getElementById(`level-title`).innerText=t.title,document.getElementById(`level-instructions`).innerText=t.instructions,o.style.display=`block`,Ml={...t.inventory},window.updateInventoryUI(),t.targets.forEach(e=>{let t=new Or(new ci(.15,16,16),new bi({color:4473924,emissive:0,roughness:.5}));t.position.set(e.pos[0],e.pos[1],e.pos[2]),t.userData.isTarget=!0,t.userData.active=!1,il.add(t),Cl.push(t)}),t.fixedObjects.forEach(e=>{Tl=e.rotH||0,El=e.rotV||0,Rl(e.type,null,e.pos,null,e.fixed)}),Tl=0,El=0,t.fixedObjects.some(e=>e.type===`laser`)){ul=!0;let e=document.getElementById(`btn-start`);e.textContent=`Stop Laser`,e.classList.add(`active`)}zl()},i.addEventListener(`click`,()=>{Ol=`sandbox`,i.classList.add(`active`),a.classList.remove(`active`),o.style.display=`none`,Ml={laser:1/0,mirror:1/0,prism:1/0,absorber:1/0},window.updateInventoryUI(),Kl()}),a.addEventListener(`click`,()=>{Ol=`challenges`,a.classList.add(`active`),i.classList.remove(`active`),window.loadLevel(kl)});let s=document.getElementById(`rotation-slider-h`),c=document.getElementById(`rotation-slider-v`),l=()=>{let e=parseFloat(s.value)*(Math.PI/180),t=parseFloat(c.value)*(Math.PI/180);if(Tl=e,El=t,xl){if(xl.userData.isFixed)return;xl.userData.rotationH=e,xl.userData.rotationV=t,xl.rotation.set(0,0,0),xl.rotation.order=`YXZ`,xl.userData.type===`laser`?(xl.rotation.y=e,xl.rotation.x=Math.PI/2-t):xl.userData.type===`mirror`&&(xl.rotation.y=e,xl.rotation.x=t),ul&&zl()}else $&&($.rotation.set(0,0,0),$.rotation.order=`YXZ`,cl===`laser`?($.rotation.y=e,$.rotation.x=Math.PI/2-t):cl===`mirror`&&($.rotation.y=e,$.rotation.x=t),zl())};s.addEventListener(`input`,l),c.addEventListener(`input`,l),window.addEventListener(`resize`,Ul),Bl()}function Il(){Ll();let e,t;cl===`laser`?(e=new ii(.02,.02,.1,16),t=new bi({color:2236962,transparent:!0,opacity:.5}),$=new Or(e,t),$.rotation.x=Math.PI/2,document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-label-h`).innerText=`Horizontal Angle`,document.getElementById(`rotation-label-v`).style.display=`block`,document.getElementById(`rotation-slider-v`).style.display=`block`):cl===`mirror`?(e=new ri(.2,.2,.02),t=new bi({color:8965375,transparent:!0,opacity:.5}),$=new Or(e,t),document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-label-h`).innerText=`Horizontal Angle`,document.getElementById(`rotation-label-v`).style.display=`block`,document.getElementById(`rotation-slider-v`).style.display=`block`):(cl===`prism`||cl===`absorber`)&&(cl===`prism`?(e=new li(.12),t=new bi({color:13434879,transparent:!0,opacity:.5})):(e=new ri(.15,.15,.15),t=new bi({color:2236962,transparent:!0,opacity:.5})),$=new Or(e,t),document.getElementById(`rotation-container`).style.display=`none`),$&&($.visible=!1,il.add($))}function Ll(){$&&(il.remove($),$=null,document.getElementById(`rotation-container`).style.display=`none`,ul||(dl.forEach(e=>il.remove(e)),dl=[]))}function Rl(e,t,n=null,r=null,i=!1){if(Ol===`challenges`&&!i){if(Ml[e]<=0)return;Ml[e]--,window.updateInventoryUI()}let a,o,s;e===`laser`?(a=new ii(.02,.02,.1,16),o=new bi({color:2236962}),s=new Or(a,o),s.userData.rotationH=Tl,s.userData.rotationV=El,n?s.position.fromArray(n):t&&s.position.setFromMatrixPosition(t),s.position.y=.05,s.rotation.order=`YXZ`,s.rotation.y=Tl,s.rotation.x=Math.PI/2-El):e===`mirror`?(a=new ri(.2,.2,.02),o=new bi({color:8965375,metalness:1,roughness:0}),s=new Or(a,o),s.userData.rotationH=Tl,s.userData.rotationV=El,n?s.position.fromArray(n):t&&s.position.setFromMatrixPosition(t),s.position.y=.1,s.rotation.order=`YXZ`,s.rotation.y=Tl,s.rotation.x=El):(e===`prism`||e===`absorber`)&&(e===`prism`?(a=new li(.12),o=new bi({color:13434879,transparent:!0,opacity:.7,metalness:.2,roughness:.1})):(a=new ri(.15,.15,.15),o=new bi({color:2236962})),s=new Or(a,o),n?s.position.fromArray(n):t&&s.position.setFromMatrixPosition(t),s.position.y=e===`prism`?.08:.075),r&&s.quaternion.fromArray(r),s.userData.type=e,s.userData.isFixed=i,i&&(s.material.emissive=new Y(2236962)),il.add(s),Sl.push(s),ul&&zl()}function zl(){if(!ul&&cl!==`laser`){dl.forEach(e=>il.remove(e)),dl=[];return}let e=Sl.filter(e=>e.userData.type===`laser`).map(e=>({pos:e.position.clone(),quat:e.quaternion.clone()}));if(cl===`laser`&&$&&$.visible&&e.push({pos:$.position.clone(),quat:$.quaternion.clone()}),e.length===0){dl.forEach(e=>e.visible=!1);return}Dl=[];let t=[];e.forEach(e=>{let n=new K(0,0,-1).applyQuaternion(e.quat).normalize(),r=e.pos.clone().add(n.clone().multiplyScalar(.05));t.push({pos:r,dir:n,depth:0,color:16777215})});let n=new xa;for(Cl.forEach(e=>e.userData.active=!1);t.length>0&&Dl.length<128;){let{pos:e,dir:r,depth:i,color:a}=t.shift();if(i>24)continue;let o=[e.clone()],s=[0],c=e.clone(),l=r.clone(),u=0,d=!1;for(;!d;){n.set(c,l);let e=[...Sl.filter(e=>e.userData.type!==`laser`),...Cl];fl&&e.push(fl);let r=n.intersectObjects(e);if(r.length>0){let e=r[0];if(e.object.userData&&e.object.userData.isTarget){e.object.userData.active=!0,u+=e.distance,o.push(e.point.clone()),s.push(u),c.copy(e.point).add(l.clone().multiplyScalar(.01));continue}if(u+=e.distance,o.push(e.point.clone()),s.push(u),e.object.userData&&e.object.userData.type===`mirror`){let n=e.face.normal.clone().applyMatrix4(new kt().extractRotation(e.object.matrixWorld));l.reflect(n).normalize(),t.push({pos:e.point.clone().add(l.clone().multiplyScalar(.001)),dir:l.clone(),depth:i+1,color:a}),d=!0}else e.object.userData&&e.object.userData.type===`prism`&&[{angle:-.15,color:a===16777215?16711680:a},{angle:0,color:a===16777215?65280:a},{angle:.15,color:a===16777215?255:a}].forEach(n=>{let r=l.clone(),a=new K(0,1,0).cross(r).normalize();a.length()<.1&&a.set(1,0,0),r.applyAxisAngle(a,n.angle),t.push({pos:e.point.clone().add(r.clone().multiplyScalar(.01)),dir:r,depth:i+1,color:n.color})}),d=!0}else u+=1e3,o.push(c.clone().add(l.clone().multiplyScalar(1e3))),s.push(u),d=!0;o.length>20&&(d=!0)}Dl.push({points:o,distances:s,color:a})}for(;dl.length<Dl.length;){let e=new ii(.01,.01,1,8);e.rotateX(Math.PI/2);let t=new Or(e,new gr({color:16777215}));il.add(t),dl.push(t)}for(;dl.length>Dl.length;){let e=dl.pop();il.remove(e)}Cl.forEach(e=>{e.userData.active?(e.material.color.setHex(16776960),e.material.emissive.setHex(11184640)):(e.material.color.setHex(4473924),e.material.emissive.setHex(0))}),Ol===`challenges`&&Cl.length>0&&!jl&&Cl.every(e=>e.userData.active)&&(jl=!0,setTimeout(()=>{kl<Nl.length-1?(Pl(`Challenge Complete! Loading next level...`),Al=Math.max(Al,kl+1),localStorage.setItem(`unlockedLevelIndex`,Al),window.loadLevel(kl+1)):(Pl(`Congratulations! You have completed all challenges!`),jl=!1)},500))}function Bl(){ml||(ml=!0,fl=new Or(new oi(100,100),new bi({color:15658734,roughness:.8})),fl.rotation.x=-Math.PI/2,fl.receiveShadow=!0,il.add(fl),pl=new wa(100,100,4473924,8947848),pl.position.y=.01,il.add(pl),Vl())}function Vl(){if(hl)return;hl=!0;let e={x:0,y:0},t=new xa,n=new G;window.addEventListener(`keydown`,e=>{_l[e.code]=!0}),window.addEventListener(`keyup`,e=>{_l[e.code]=!1}),window.addEventListener(`wheel`,e=>{ml&&(vl.radius=Math.max(.5,Math.min(20,vl.radius+e.deltaY*.005)),r())});function r(){rl.position.x=yl.x+vl.radius*Math.sin(vl.phi)*Math.cos(vl.theta),rl.position.y=yl.y+vl.radius*Math.cos(vl.phi),rl.position.z=yl.z+vl.radius*Math.sin(vl.phi)*Math.sin(vl.theta),rl.lookAt(yl)}r();let i=e=>{n.x=e.clientX/window.innerWidth*2-1,n.y=-(e.clientY/window.innerHeight)*2+1};window.addEventListener(`pointerdown`,t=>{t.target.tagName===`CANVAS`&&(gl=!0,wl={x:t.clientX,y:t.clientY},e={x:t.clientX,y:t.clientY})}),window.addEventListener(`pointermove`,e=>{(!ml||e.target.tagName!==`CANVAS`)&&(gl||(sl.visible=!1)),i(e),t.setFromCamera(n,rl);let a=t.intersectObject(fl);if(a.length>0?(sl.visible=!0,sl.position.copy(a[0].point)):sl.visible=!1,!gl)return;let o=e.clientX-wl.x,s=e.clientY-wl.y;vl.theta-=o*.01,vl.phi=Math.max(.1,Math.min(Math.PI/2-.1,vl.phi-s*.01)),wl={x:e.clientX,y:e.clientY},r()}),window.addEventListener(`pointerup`,r=>{if(gl&&(gl=!1,Math.sqrt((r.clientX-e.x)**2+(r.clientY-e.y)**2)<10&&ml&&r.target.tagName===`CANVAS`)){i(r),t.setFromCamera(n,rl);let e=t.intersectObjects(Sl);if(e.length>0){let t=e[0].object;if(ll){if(t.userData.isFixed){Pl(`This object is fixed and cannot be removed!`);return}il.remove(t),Sl=Sl.filter(e=>e!==t),Ol===`challenges`&&(Ml[t.userData.type]++,window.updateInventoryUI()),xl===t&&(xl=null,document.getElementById(`rotation-container`).style.display=`none`),ul&&zl();return}if(t.userData.type===`laser`||t.userData.type===`mirror`){xl=t,cl=null,document.querySelectorAll(`.inventory-item`).forEach(e=>e.style.background=``),Ll(),document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-slider-h`).value=(t.userData.rotationH||0)*(180/Math.PI),document.getElementById(`rotation-slider-v`).value=(t.userData.rotationV||0)*(180/Math.PI);return}}let a=t.intersectObject(fl);cl&&a.length>0&&Rl(cl,null,a[0].point.toArray())}}),window.update3DMovement=()=>{if(!ml)return;let e=!1,t=.05,n=new K;rl.getWorldDirection(n),n.y=0,n.normalize();let i=new K().crossVectors(n,new K(0,1,0)).normalize();_l.KeyW&&(yl.add(n.clone().multiplyScalar(t)),e=!0),_l.KeyS&&(yl.sub(n.clone().multiplyScalar(t)),e=!0),_l.KeyA&&(yl.add(i.clone().multiplyScalar(t)),e=!0),_l.KeyD&&(yl.sub(i.clone().multiplyScalar(t)),e=!0),_l.ArrowUp&&(vl.radius-=.1,e=!0),_l.ArrowDown&&(vl.radius+=.1,e=!0),e&&(vl.radius=Math.max(.5,Math.min(20,vl.radius)),r(),bl&&Hl())}}function Hl(){!bl||!pl||!fl||(pl.position.x=Math.floor(yl.x/1)*1,pl.position.z=Math.floor(yl.z/1)*1,fl.position.x=pl.position.x,fl.position.z=pl.position.z)}function Ul(){rl.aspect=window.innerWidth/window.innerHeight,rl.updateProjectionMatrix(),al.setSize(window.innerWidth,window.innerHeight),ol&&ol.setSize(window.innerWidth,window.innerHeight)}function Wl(){al.setAnimationLoop(Gl)}function Gl(){window.update3DMovement&&window.update3DMovement(),ul&&zl(),$&&(sl.visible?($.visible=!0,$.position.copy(sl.position),cl===`laser`?$.position.y=.05:cl===`mirror`?$.position.y=.1:cl===`prism`?$.position.y=.08:cl===`absorber`&&($.position.y=.075),$.updateMatrixWorld(),zl()):($.visible=!1,ul||(dl.forEach(e=>il.remove(e)),dl=[]))),(ul||cl===`laser`)&&dl.length>0&&Dl.length>0?Dl.forEach((e,t)=>{let n=dl[t];if(!n||e.points.length<2){n&&(n.visible=!1);return}n.material.color.setHex(e.color||16777215);let r=e.points[0],i=e.points[e.points.length-1],a=new K().subVectors(i,r),o=a.length();n.scale.set(1,1,o),n.position.copy(r).add(a.clone().multiplyScalar(.5)),n.lookAt(i),n.visible=!0}):ul||dl.forEach(e=>e.visible=!1),ol?ol.render():al.render(il,rl)}function Kl(){Ll(),Sl.forEach(e=>il.remove(e)),Sl=[],Cl.forEach(e=>il.remove(e)),Cl=[],dl.forEach(e=>il.remove(e)),dl=[],il.traverse(e=>{e.userData&&e.userData.isTarget&&il.remove(e)}),xl=null;let e=document.getElementById(`rotation-container`);e&&(e.style.display=`none`),ul=!1;let t=document.getElementById(`btn-start`);t&&(t.textContent=`Start Laser`,t.classList.remove(`active`))}