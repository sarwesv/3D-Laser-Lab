...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(e,t,n){let r=new Float32Array(za),i=new q(0,1,0);return new _i({name:`SphericalGaussianBlur`,defines:{n:za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(){return new _i({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:no(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function to(){return new _i({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:no(),fragmentShader:`
	...
	`}var ro=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $r(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};el.BlurDirectionX=new K(1,0),el.BlurDirectionY=new K(0,1);var tl,nl,rl,il,al,ol,sl=null,cl=!1,ll=!1,$=null,ul=[],dl,fl,pl=!1,ml=!1,hl=!1,gl={},_l={theta:Math.PI/4,phi:Math.PI/4,radius:3},vl=new q(0,0,0),yl=!1,bl=null,xl=[],Sl={x:0,y:0},Cl=0,wl=0,Tl=[];El(),Fl();function El(){tl=document.getElementById(`container`),rl=new dn,rl.background=new X(16119802),nl=new Zi(70,window.innerWidth/window.innerHeight,.01,20);let e=new zi(16777215,12303359,1);e.position.set(.5,1,.25),rl.add(e);let t=new ea(16777215,.5);t.position.set(5,10,5),rl.add(t),il=new Hc({antialias:!0,alpha:!0}),il.setPixelRatio(window.devicePixelRatio),il.setSize(window.innerWidth,window.innerHeight),tl.appendChild(il.domElement),al=new Zc(il);let n=new Qc(rl,nl);al.addPass(n);let r=new el(new K(window.innerWidth,window.innerHeight),0,.3,.9);al.addPass(r),ol=new Or(new si(.15,.2,32).rotateX(-Math.PI/2),new gr({color:16777215,transparent:!0,opacity:.5})),ol.visible=!1,rl.add(ol),document.querySelectorAll(`.inventory-item`).forEach(e=>{e.addEventListener(`click`,()=>{if(e.id===`btn-delete`){cl=!cl,e.classList.toggle(`active`,cl),cl&&(sl=null,document.querySelectorAll(`.inventory-item`).forEach(e=>{e.id!==`btn-delete`&&(e.style.background=``)}),Ol());return}sl=sl===e.dataset.type?null:e.dataset.type,sl&&(cl=!1,bl=null,document.getElementById(`btn-delete`).classList.remove(`active`),document.getElementById(`rotation-container`).style.display=`none`),document.querySelectorAll(`.inventory-item`).forEach(e=>{e.id!==`btn-delete`&&(e.style.background=``)}),sl?(e.style.background=`rgba(255, 255, 255, 0.2)`,Dl()):Ol()})}),document.getElementById(`btn-start`).addEventListener(`click`,()=>{let e=xl.some(e=>e.userData.type===`laser`);if(!ll&&!e){alert(`Please place at least one Laser Emitter first!`);return}ll=!ll;let t=document.getElementById(`btn-start`);t.textContent=ll?`Stop Laser`:`Start Laser`,t.classList.toggle(`active`,ll),Al()}),document.getElementById(`btn-grid-toggle`).addEventListener(`click`,()=>{yl=!yl;let e=document.getElementById(`btn-grid-toggle`);e.textContent=yl?`🌐 Grid: Infinite`:`🌐 Grid: Fixed`,e.classList.toggle(`active`,yl),!yl&&fl&&dl?(fl.position.set(0,0,0),dl.position.set(0,0,0)):Nl()}),document.getElementById(`btn-toggle-menu`).addEventListener(`click`,()=>{let e=document.getElementById(`action-menu`).classList.toggle(`collapsed`);document.getElementById(`btn-toggle-menu`).innerText=e?`⚙️`:`❌`}),document.getElementById(`btn-clear`).addEventListener(`click`,()=>{window.confirm(`Are you sure you want to clear all objects? This cannot be undone.`)&&Ll()});let i=document.getElementById(`rotation-slider-h`),a=document.getElementById(`rotation-slider-v`),o=()=>{let e=parseFloat(i.value)*(Math.PI/180),t=parseFloat(a.value)*(Math.PI/180);Cl=e,wl=t,bl?(bl.userData.rotationH=e,bl.userData.rotationV=t,bl.rotation.set(0,0,0),bl.rotation.order=`YXZ`,bl.userData.type===`laser`?(bl.rotation.y=e,bl.rotation.x=Math.PI/2-t):bl.userData.type===`mirror`&&(bl.rotation.y=e,bl.rotation.x=t),ll&&Al()):$&&($.rotation.set(0,0,0),$.rotation.order=`YXZ`,sl===`laser`?($.rotation.y=e,$.rotation.x=Math.PI/2-t):sl===`mirror`&&($.rotation.y=e,$.rotation.x=t),Al())};i.addEventListener(`input`,o),a.addEventListener(`input`,o),window.addEventListener(`resize`,Pl),jl()}function Dl(){Ol();let e,t;sl===`laser`?(e=new ii(.02,.02,.1,16),t=new yi({color:2236962,transparent:!0,opacity:.5}),$=new Or(e,t),$.rotation.x=Math.PI/2,document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-label-h`).innerText=`Horizontal Angle`,document.getElementById(`rotation-label-v`).style.display=`block`,document.getElementById(`rotation-slider-v`).style.display=`block`):sl===`mirror`?(e=new ri(.2,.2,.02),t=new yi({color:8965375,transparent:!0,opacity:.5}),$=new Or(e,t),document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-label-h`).innerText=`Horizontal Angle`,document.getElementById(`rotation-label-v`).style.display=`block`,document.getElementById(`rotation-slider-v`).style.display=`block`):(sl===`prism`||sl===`absorber`)&&(sl===`prism`?(e=new ci(.12),t=new yi({color:13434879,transparent:!0,opacity:.5})):(e=new ri(.15,.15,.15),t=new yi({color:2236962,transparent:!0,opacity:.5})),$=new Or(e,t),document.getElementById(`rotation-container`).style.display=`none`),$&&($.visible=!1,rl.add($))}function Ol(){$&&(rl.remove($),$=null,document.getElementById(`rotation-container`).style.display=`none`,ll||(ul.forEach(e=>rl.remove(e)),ul=[]))}function kl(e,t,n=null,r=null){let i,a,o;e===`laser`?(i=new ii(.02,.02,.1,16),a=new yi({color:2236962}),o=new Or(i,a),o.userData.rotationH=Cl,o.userData.rotationV=wl,n?o.position.fromArray(n):t&&o.position.setFromMatrixPosition(t),o.position.y=.02,o.rotation.order=`YXZ`,o.rotation.y=Cl,o.rotation.x=Math.PI/2-wl):e===`mirror`?(i=new ri(.2,.2,.02),a=new yi({color:8965375,metalness:1,roughness:0}),o=new Or(i,a),o.userData.rotationH=Cl,o.userData.rotationV=wl,n?o.position.fromArray(n):t&&o.position.setFromMatrixPosition(t),o.position.y=.1,o.rotation.order=`YXZ`,o.rotation.y=Cl,o.rotation.x=wl):(e===`prism`||e===`absorber`)&&(e===`prism`?(i=new ci(.12),a=new yi({color:13434879,transparent:!0,opacity:.7,metalness:.2,roughness:.1})):(i=new ri(.15,.15,.15),a=new yi({color:2236962})),o=new Or(i,a),n?o.position.fromArray(n):t&&o.position.setFromMatrixPosition(t),o.position.y=e===`prism`?.08:.075),r&&o.quaternion.fromArray(r),o.userData.type=e,rl.add(o),xl.push(o),ll&&Al()}function Al(){if(!ll&&sl!==`laser`){ul.forEach(e=>rl.remove(e)),ul=[];return}let e=xl.filter(e=>e.userData.type===`laser`).map(e=>({pos:e.position.clone(),quat:e.quaternion.clone()}));if(sl===`laser`&&$&&$.visible&&e.push({pos:$.position.clone(),quat:$.quaternion.clone()}),e.length===0){ul.forEach(e=>e.visible=!1);return}Tl=[];let t=[];e.forEach(e=>{let n=new q(0,0,-1).applyQuaternion(e.quat).normalize(),r=e.pos.clone().add(n.clone().multiplyScalar(.05));t.push({pos:r,dir:n,depth:0})});let n=new ba;for(;t.length>0&&Tl.length<64;){let{pos:e,dir:r,depth:i}=t.shift();if(i>24)continue;let a=[e.clone()],o=[0],s=e.clone(),c=r.clone(),l=0,u=!1;for(;!u;){n.set(s,c);let e=[...xl.filter(e=>e.userData.type!==`laser`)];dl&&e.push(dl);let r=n.intersectObjects(e);if(r.length>0){let e=r[0];if(l+=e.distance,a.push(e.point.clone()),o.push(l),e.object.userData&&e.object.userData.type===`mirror`){let n=e.face.normal.clone().applyMatrix4(new Ot().extractRotation(e.object.matrixWorld));c.reflect(n).normalize(),t.push({pos:e.point.clone().add(c.clone().multiplyScalar(.001)),dir:c.clone(),depth:i+1}),u=!0}else e.object.userData&&e.object.userData.type===`prism`&&[-.15,0,.15].forEach(n=>{let r=c.clone(),a=new q(0,1,0).cross(r).normalize();a.length()<.1&&a.set(1,0,0),r.applyAxisAngle(a,n),t.push({pos:e.point.clone().add(r.clone().multiplyScalar(.01)),dir:r,depth:i+1})}),u=!0}else l+=1e3,a.push(s.clone().add(c.clone().multiplyScalar(1e3))),o.push(l),u=!0;a.length>20&&(u=!0)}Tl.push({points:a,distances:o})}for(;ul.length<Tl.length;){let e=new ii(.01,.01,1,8);e.rotateX(Math.PI/2);let t=new Or(e,new gr({color:16711680}));rl.add(t),ul.push(t)}for(;ul.length>Tl.length;){let e=ul.pop();rl.remove(e)}}function jl(){pl||(pl=!0,dl=new Or(new oi(100,100),new yi({color:15658734,roughness:.8})),dl.rotation.x=-Math.PI/2,dl.receiveShadow=!0,rl.add(dl),fl=new Ca(100,100,4473924,8947848),fl.position.y=.01,rl.add(fl),Ml())}function Ml(){if(ml)return;ml=!0;let e={x:0,y:0},t=new ba,n=new K;window.addEventListener(`keydown`,e=>{gl[e.code]=!0}),window.addEventListener(`keyup`,e=>{gl[e.code]=!1}),window.addEventListener(`wheel`,e=>{pl&&(_l.radius+=e.deltaY*.005,_l.radius=Math.max(.5,Math.min(20,_l.radius)),r())});function r(){nl.position.x=vl.x+_l.radius*Math.sin(_l.phi)*Math.cos(_l.theta),nl.position.y=vl.y+_l.radius*Math.cos(_l.phi),nl.position.z=vl.z+_l.radius*Math.sin(_l.phi)*Math.sin(_l.theta),nl.lookAt(vl)}r();let i=e=>{n.x=e.clientX/window.innerWidth*2-1,n.y=-(e.clientY/window.innerHeight)*2+1};window.addEventListener(`pointerdown`,t=>{t.target.tagName===`CANVAS`&&(hl=!0,Sl={x:t.clientX,y:t.clientY},e={x:t.clientX,y:t.clientY})}),window.addEventListener(`pointermove`,e=>{(!pl||e.target.tagName!==`CANVAS`)&&(hl||(ol.visible=!1)),i(e),t.setFromCamera(n,nl);let a=t.intersectObject(dl);if(a.length>0?(ol.visible=!0,ol.position.copy(a[0].point)):ol.visible=!1,!hl)return;let o=e.clientX-Sl.x,s=e.clientY-Sl.y;_l.theta-=o*.01,_l.phi-=s*.01,_l.phi=Math.max(.1,Math.min(Math.PI/2-.1,_l.phi)),Sl={x:e.clientX,y:e.clientY},r()}),window.addEventListener(`pointerup`,r=>{if(hl&&(hl=!1,Math.sqrt((r.clientX-e.x)**2+(r.clientY-e.y)**2)<10&&pl&&r.target.tagName===`CANVAS`)){i(r),t.setFromCamera(n,nl);let e=t.intersectObjects(xl);if(e.length>0){let t=e[0].object;if(cl){rl.remove(t),xl=xl.filter(e=>e!==t),bl===t&&(bl=null,document.getElementById(`rotation-container`).style.display=`none`),ll&&Al();return}if(t.userData.type===`laser`||t.userData.type===`mirror`){bl=t,sl=null,document.querySelectorAll(`.inventory-item`).forEach(e=>e.style.background=``),Ol(),document.getElementById(`rotation-container`).style.display=`block`,document.getElementById(`rotation-slider-h`).value=(t.userData.rotationH||0)*(180/Math.PI),document.getElementById(`rotation-slider-v`).value=(t.userData.rotationV||0)*(180/Math.PI);return}}let a=t.intersectObject(dl);sl&&a.length>0&&kl(sl,null,a[0].point.toArray())}}),window.update3DMovement=()=>{if(!pl)return;let e=!1,t=.05,n=new q;nl.getWorldDirection(n),n.y=0,n.normalize();let i=new q().crossVectors(n,new q(0,1,0)).normalize();gl.KeyW&&(vl.add(n.clone().multiplyScalar(t)),e=!0),gl.KeyS&&(vl.sub(n.clone().multiplyScalar(t)),e=!0),gl.KeyA&&(vl.add(i.clone().multiplyScalar(t)),e=!0),gl.KeyD&&(vl.sub(i.clone().multiplyScalar(t)),e=!0),gl.ArrowUp&&(_l.radius-=.1,e=!0),gl.ArrowDown&&(_l.radius+=.1,e=!0),e&&(_l.radius=Math.max(.5,Math.min(20,_l.radius)),r(),yl&&Nl())}}function Nl(){!yl||!fl||!dl||(fl.position.x=Math.floor(vl.x/1)*1,fl.position.z=Math.floor(vl.z/1)*1,dl.position.x=fl.position.x,dl.position.z=fl.position.z)}function Pl(){nl.aspect=window.innerWidth/window.innerHeight,nl.updateProjectionMatrix(),il.setSize(window.innerWidth,window.innerHeight),al&&al.setSize(window.innerWidth,window.innerHeight)}function Fl(){il.setAnimationLoop(Il)}function Il(){window.update3DMovement&&window.update3DMovement(),ll&&Al(),$&&(ol.visible?($.visible=!0,$.position.copy(ol.position),sl===`laser`?$.position.y=.02:sl===`mirror`?$.position.y=.1:sl===`prism`?$.position.y=.08:sl===`absorber`&&($.position.y=.075),$.updateMatrixWorld(),Al()):($.visible=!1,ll||(ul.forEach(e=>rl.remove(e)),ul=[]))),(ll||sl===`laser`)&&ul.length>0&&Tl.length>0?Tl.forEach((e,t)=>{let n=ul[t];if(!n||e.points.length<2){n&&(n.visible=!1);return}let r=e.points[0],i=e.points[e.points.length-1],a=new q().subVectors(i,r),o=a.length();n.scale.set(1,1,o),n.position.copy(r).add(a.clone().multiplyScalar(.5)),n.lookAt(i),n.visible=!0}):ll||ul.forEach(e=>e.visible=!1),al?al.render():il.render(rl,nl)}function Ll(){xl.forEach(e=>rl.remove(e)),xl=[],ul.forEach(e=>rl.remove(e)),ul=[],bl=null;let e=document.getElementById(`rotation-container`);e&&(e.style.display=`none`)}